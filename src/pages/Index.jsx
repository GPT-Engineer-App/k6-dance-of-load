        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Maine Coon: One of the largest domestic cat breeds, known for their intelligence and playful personality.</li>
              <li>Persian: Recognized for their long, luxurious coat and flat face.</li>
              <li>Bengal: A wild-looking breed with a spotted or marbled coat pattern.</li>
            </ul>
          </CardContent>
        </Card>
      </div>
